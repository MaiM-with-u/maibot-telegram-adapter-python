# TODO: implement send_handler.py
# This file is just copied from https://github.com/MaiM-with-u/MaiBot-Napcat-Adapter/blob/main/src/send_handler.py
# it needs to be modified to fit the current project structure and requirements.
...
class SendHandler:
    def __init__(self):
        self.server_connection: websockets.ServerConnection = None
